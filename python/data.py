...
def read_data(data_file_names, instance):
    ...
    for data_file in data_file_names:
        ...
        if data_file == "DistanceTimesCoordinates.csv":
            with open("instances/"+instance+"/"+data_file) as csv_file:
            ...
            fleet = pd.read_csv("instances/"+instance+"/"+data_file, encoding="cp1252", sep=";")
            ...
            locations = pd.read_csv("instances/"+instance+"/"+data_file, encoding="cp1252", sep=";")
            ...
            swap_actions = pd.read_csv("instances/"+instance+"/"+data_file, encoding="cp1252", sep=";")
...
def write_data(solution):
    ...
    for route in solution:
        ...
        for location in route:
            location_list = [location["ROUTE_ID"],
                             location["ROUTE_LOCATION"],
                             location["LOCATION_POS"],
                             location["LOCATION_ID"],
                             location["LOCATION_TYPE"],
                             location["SEMI_TRAILER_ATTACHED"],
                             location["SWAP_BODY_TRUCK"],
                             location["SWAP_BODY_SEMI_TRAILER"],
                             location["SWAP_ACTION"],
                             location["SWAP_BODY_1_QUANTITY"],
                             location["SWAP_BODY_2_QUANTITY"]
                             ]
            route_list.append(location_list)
        solution_list.append(route_list)
