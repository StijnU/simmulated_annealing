...
# exe = "~/bin/executable"
exe = "C:/Users/Stijn/PycharmProjects/simulated_annealing/main.exe"

fixed_params = "DistanceTimesCoordinates.csv DistanceTimesData.csv Fleet.csv Locations.csv SwapActions.csv"
...
start_temp = sys.argv[1]
exit_temp = sys.argv[2]
alpha = sys.argv[3]
...
command = [exe] + fixed_params.split() + [instance] + [0] + [start_temp] + [exit_temp] + [alpha]
